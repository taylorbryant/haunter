...
export const pageRoutes = defineRouteGroup({
	...
	routes: [
		...
		{ contract: getPageMetadata, useCase: getPageMetadataUseCase },
		{ contract: getPageNavigation, useCase: getPageNavigationUseCase },
		{ contract: setPageFavorite, useCase: setPageFavoriteUseCase },
		{ contract: recordPageView, useCase: recordPageViewUseCase },
